...
public class Syntax_Class extends AppCompatActivity {
    private Button mbtn_kembali;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_syntax__class);
        mbtn_kembali= (Button) findViewById(R.id.kembali_Syntax);

        mbtn_kembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ikembali = new Intent(getApplicationContext(),Class.class);
