...
public class Syntax_Button extends AppCompatActivity {
    private Button mbtn_kembali;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_syntax__button);
        mbtn_kembali= (Button) findViewById(R.id.kembali_Syntax);

        mbtn_kembali.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ikembali = new Intent(getApplicationContext(),Button.class);
